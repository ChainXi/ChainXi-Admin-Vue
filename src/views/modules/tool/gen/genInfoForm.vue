...
const genInfoForm = useTemplateRef('genInfoForm')
const validate = (c)=>{
  console.debug(genInfoForm.value)
  genInfoForm.value.validate(c)
}
...
function getMenuTreeselect() {
  getMenuList(undefined).then((response) => {
    menuOptions.value = handleTree(response.data, 'id', 'children', (e) => e.pid)
  })
}
onMounted(() => {
  getMenuTreeselect()
