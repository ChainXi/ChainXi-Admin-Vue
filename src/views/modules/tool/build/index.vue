    ...
    <div class="center-board">
      ...
      <el-scrollbar class="center-scrollbar">
        <el-row class="center-board-row" :gutter="formConf.gutter">
          ...
          >
            <draggable class="drawing-board" :list="drawingList" :animation="340" group="componentsGroup" item-key="label">
              <template #item="{ element, index }">
                <draggable-item
...
function empty() {
  message.confirm('确定要清空所有组件吗？', '提示').then(() => {
    idGlobal.value = 100
    drawingList.value = []
  })
}
